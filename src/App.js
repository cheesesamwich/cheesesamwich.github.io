...
{
  if(id == (undefined || null)) { return null; }
  return scripts.concat(tuts).find(video => video.id === id && video.id != null | undefined);
}
function App() {
  ...
  let gotInfo = getElementFromID(infoPage);
  let isInfoGood = gotInfo !== undefined | null;

  let safeDescription, safeName;
  if (gotInfo != null | undefined) {
    safeDescription = gotInfo.description;
    safeName = gotInfo.name;
  } else {
    safeDescription = "error";
    safeName = "error";
  }
  ...
  return (
    <div className="container">
      ...
      {infoPage && <div id='scriptInfo'><ScriptInfo data={gotInfo}></ScriptInfo></div>}  
  ...
  return (
    <div className="script-tile">
      ...
      <div className="button-container">
        ...
        <a className='rounded-link buttonAnim' href={`?info=${props.scriptID}`}>
