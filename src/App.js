      ...
      return (
        <div id='mainAppContent'>
          ...
          <h3>Medium Experience</h3>
            ...
            <ShieldsTile shieldslink="https://img.shields.io/badge/React-20232A?style=for-the-badge&logo=react&logoColor=61DAFB"></ShieldsTile>
        </div>
      )
    case "music":
      return (
      ...
      return (
        <div id='mainAppContent'>
          ...
          <BlogPost 
            ...
            postContent='A little update on the music tab thing; apparently i cant do what im trying to achieve with github secrets/actions, so i need to host it on a vps, give up, or literally just commit the code with the api key in (which i will if things come to it lmao). But in the mean time, heres a picture of the music feature that will probably never exist '>  
          </BlogPost>
...
function BlogPost(props) {
  ...
  linesText.forEach(element => {
    ...
    return (
      <div id="content" style={{ paddingLeft: '2%', paddingRight: '2%', paddingBlock: '1%' }}>
        ...
        {isVisible && (
          <div>
            {lines}
            <br></br>
            {props.imageLink !== undefined && (<img src={props.imageLink} style={{borderRadius: '30px', height: '500px'}}></img>)}
          </div>
        )}
